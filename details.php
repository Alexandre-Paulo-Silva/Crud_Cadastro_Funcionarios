...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
  ...
  <img width="90px" height="70px" src="imagens/cecon-logo.jpg"/>
  </a>
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      <li class="nav-item active">
        <a class="nav-link" href="/cecon/index.php">Home<span class="sr-only">(current)</span></a>
      </li>
       <li class="nav-item">
        <a class="nav-link" href="/cecon/register.php">Cadastrar</a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="/cecon/list.php">Listar</a>
      </li>
      <li class="nav-item">
...
<div class="col-md-10">
<h3 class="text-center text-dark mt-2">SISCAFCE - Sistema de Cadastro Funcionário Fcecon</h3>
<hr>
</nav>
  <div class="container">
    <div class="row justify-content-center">
